...
contract DolphinetSwapOracleStorage {
    ...
    error DolphinetSwapOracle_InvalidPair();
    error DolphinetSwapOracle_InsufficientElapsedTime();
    error DolphinetSwapOracle_InvalidToken();
}
